                  ...
                  <div className="absolute right-0 top-full mt-2 w-72 bg-slate-800 border border-slate-700 rounded-xl shadow-xl z-50 overflow-hidden max-h-[80vh] overflow-y-auto">
                    ...
                    <div className="px-4 py-2 bg-gradient-to-r from-purple-600/20 to-emerald-600/20 border-t border-b border-slate-700 mt-1">
                      <p className="text-xs text-purple-300 uppercase tracking-wider font-semibold flex items-center gap-2">
                        ...
                        {isSatf ? 'Relatórios IA · SATF TI v3' : 'Relatórios IA · MIT CISR'}
                      </p>
                      <p className="text-[10px] text-slate-400 mt-0.5">
                        {isSatf
                          ? 'Gerados pela IA com instrumento SATF TI v3 (SysMap Solutions)'
                          : 'Gerados pela IA com metodologia SysMap Blueprint IA'}
                      </p>
                    </div>
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        <p className="text-sm font-medium text-white">
                          {isSatf ? 'Executivo TI / Engenharia (IA)' : 'Estratégico C-Level (IA)'}
                        </p>
                        <p className="text-[10px] text-slate-400">
                          {isSatf
                            ? 'Resumo SATF · 5 seções · foco CTO/plataforma'
                            : 'Resumo executivo · 5 seções · ~30-60s'}
                        </p>
                      </div>
                    </button>
              ...
              <div className="bg-slate-800 rounded-xl p-6 border border-slate-700 mb-6">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <h3 className="text-white font-semibold">
                    {isSatf
                      ? 'Maturidade IA em TI — escala operacional SATF TI v3 (N1–N5)'
