/**
 * Persona e atribuição dos relatórios/books na UI e exportações.
 * Consultores = SysMap Solutions. MIT CISR = referência metodológica.
 */
...
export const LABEL_METODOLOGIA = `Metodologia ${METODOLOGIA_BLUEPRINT_RESUMO}`;
