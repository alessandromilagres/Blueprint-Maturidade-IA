...
const MAPA_CARGOS_DIMENSOES_AVALIACAO = {
  CEO: [
    DIMENSOES.estrategia, DIMENSOES.governanca, DIMENSOES.dados,
    DIMENSOES.maturidadeTipo, DIMENSOES.talentos, DIMENSOES.cultura,
    DIMENSOES.operacoes, DIMENSOES.inovacao, DIMENSOES.roi,
    DIMENSOES.receita, DIMENSOES.valorUnidade, DIMENSOES.ecossistema,
    DIMENSOES.eficacia, DIMENSOES.conformidade, DIMENSOES.mudanca
  ],
  CIO: [
    DIMENSOES.estrategia, DIMENSOES.governanca, DIMENSOES.dados,
    DIMENSOES.maturidadeTipo, DIMENSOES.talentos, DIMENSOES.inovacao,
    DIMENSOES.roi, DIMENSOES.receita, DIMENSOES.valorUnidade,
    DIMENSOES.ecossistema, DIMENSOES.eficacia, DIMENSOES.conformidade,
    DIMENSOES.mudanca
  ],
  CTO: [
    DIMENSOES.estrategia, DIMENSOES.governanca, DIMENSOES.dados,
    DIMENSOES.plataforma, DIMENSOES.maturidadeTipo, DIMENSOES.talentos,
    DIMENSOES.inovacao, DIMENSOES.receita, DIMENSOES.ecossistema,
  ...
  'Governança Operacional': [
    DIMENSOES.estrategia, DIMENSOES.governanca, DIMENSOES.talentos,
    DIMENSOES.cultura, DIMENSOES.operacoes, DIMENSOES.roi,
    DIMENSOES.receita, DIMENSOES.valorUnidade, DIMENSOES.ecossistema,
    DIMENSOES.eficacia, DIMENSOES.conformidade, DIMENSOES.mudanca
  ],
  Negócios: [
  ...
  'Head de Arquitetura': [
    DIMENSOES.estrategia, DIMENSOES.governanca, DIMENSOES.dados,
    DIMENSOES.plataforma, DIMENSOES.maturidadeTipo, DIMENSOES.inovacao,
    DIMENSOES.receita, DIMENSOES.ecossistema
  ],
  Produto: [
    DIMENSOES.estrategia, DIMENSOES.governanca, DIMENSOES.dados,
    DIMENSOES.plataforma, DIMENSOES.maturidadeTipo, DIMENSOES.inovacao,
  ...
  'Governança de Sistemas': [
    DIMENSOES.governanca, DIMENSOES.dados, DIMENSOES.plataforma,
    DIMENSOES.operacoes, DIMENSOES.ecossistema, DIMENSOES.conformidade
  ],
  'Infra e Segurança': [
    DIMENSOES.governanca, DIMENSOES.dados, DIMENSOES.plataforma,
    DIMENSOES.operacoes, DIMENSOES.ecossistema, DIMENSOES.conformidade
  ...
  Delivery: [
    DIMENSOES.plataforma, DIMENSOES.maturidadeTipo, DIMENSOES.talentos,
    DIMENSOES.cultura, DIMENSOES.operacoes, DIMENSOES.inovacao,
    DIMENSOES.roi, DIMENSOES.receita, DIMENSOES.valorUnidade,
    DIMENSOES.eficacia, DIMENSOES.mudanca
  ],
  PMO: [
    DIMENSOES.governanca, DIMENSOES.talentos, DIMENSOES.cultura,
    DIMENSOES.operacoes, DIMENSOES.inovacao, DIMENSOES.roi,
    DIMENSOES.valorUnidade, DIMENSOES.eficacia, DIMENSOES.mudanca
  ],
  RH: [
    DIMENSOES.talentos, DIMENSOES.cultura, DIMENSOES.conformidade,
    DIMENSOES.mudanca
  ]
};
